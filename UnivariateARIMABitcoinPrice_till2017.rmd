...
#Explore the data
daily_data = read.csv('/home/anityagupta/documents/dpa/courses/da/project/datasets/cleaned_dataset/bitcoin_price_new_volume_filled.csv', header=TRUE, stringsAsFactors=FALSE)
str(daily_data)
